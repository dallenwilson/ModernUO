 ...
 *
 * Updated for ModernUO & modified somewhat on 2026-03-11 by Warped (dwilson)
 *
...
namespace Server.Items
{
    ...
    public partial class SmallBagofHolding : WeightReductionContainer
    {
    ...
    [SerializationGenerator(0, false)]
    public partial class MediumBagofHolding : WeightReductionContainer
    {
        // Set weight reduction to 100%
        public override double WeightReductionAmount { get { return 1.0; } }
    ...
    [SerializationGenerator(0, false)]
    public partial class LargeBagofHolding : WeightReductionContainer
    {
        // Set weight reduction to 100%
        public override double WeightReductionAmount { get { return 1.0; } }
        ...
        // Limit the maximum items
        public override int ContainerMaxItems { get { return 15; } }
    ...
    // This is an example of a container that reduces total weight by 10% to 75%
    [SerializationGenerator(0, false)]
    public partial class BagofWonder : WeightReductionContainer
    {
        public override double WeightReductionAmount { get { return ((double)Utility.Random(10, 75) / 100); } }
        ...
        public BagofWonder(Serial serial) : base(serial)
        {
        }
    }
    ...
    [SerializationGenerator(0, false)]
    public partial class MysticBox : WeightReductionContainer
    {
        ...
        public MysticBox(Serial serial) : base (serial)
        {
        }
    }
    ...
    public abstract partial class WeightReductionContainer : BaseContainer
    {
        ...
        public WeightReductionContainer(Serial serial) : base(serial)
        {
        }
